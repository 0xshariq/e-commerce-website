          ...
          <div className="lg:col-span-2 space-y-6">
            <Card className="bg-gray-800/90 backdrop-blur-sm border-gray-700">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400 text-sm">Update your store details</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="storeName" className="text-gray-300 text-sm font-medium">
                      Store Name
                    </Label>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        id="upiId"
                        defaultValue={session.user.upiId}
                        className="pl-10 bg-gray-700/50 border-gray-600 text-white h-11"
                      />
                    </div>
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Textarea
                      id="shopAddress"
                      defaultValue={session.user.shopAddress}
                      className="pl-10 bg-gray-700/50 border-gray-600 text-white min-h-[80px]"
                      rows={3}
                    />
                  </div>
                </div>
                <Button className="bg-green-600 hover:bg-green-700 w-full sm:w-auto">Save Changes</Button>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gray-800/90 backdrop-blur-sm border-gray-700">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400 text-sm">Your store statistics</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  ...
                  <div className="text-center bg-gray-700/30 rounded-lg p-4">
                    <div className="text-xl sm:text-2xl font-bold text-purple-400">$12.2K</div>
                    <div className="text-xs sm:text-sm text-gray-400 flex items-center justify-center gap-1">
                  ...
                  <div className="text-center bg-gray-700/30 rounded-lg p-4">
                    <div className="text-xl sm:text-2xl font-bold text-orange-400">4.8</div>
