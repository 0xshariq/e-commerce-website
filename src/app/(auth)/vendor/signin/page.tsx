...
import { Eye, EyeOff, Mail, Lock, AlertCircle, Package, ArrowLeft, Store, Loader2 } from "lucide-react"
    ...
    try {
      ...
      if (result?.error) {
        ...
        if (session?.user?.role === "vendor") {
          ...
          setAuthError("Invalid account type. Please use vendor credentials.")
        }
      }
    } catch (error) {
          ...
          <CardHeader className="text-center space-y-4 pb-6">
            ...
            <div className="flex items-center justify-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-xl sm:text-2xl text-white">Vendor Sign In</CardTitle>
              </div>
            </div>
