...
import { Shield, Edit, Key, Activity, Users, Store, AlertTriangle, Camera, Phone, Mail } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
        ...
        <div className="mb-6 lg:mb-8">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-2">Admin Profile</h1>
          <p className="text-gray-400 text-sm sm:text-base">Manage your administrator account and system settings</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <Card className="bg-gray-800/90 backdrop-blur-sm border-gray-700 lg:col-span-1">
            <CardHeader className="text-center pb-4">
              ...
              <Badge variant="outline" className="border-purple-600 text-purple-400 w-fit mx-auto mt-2">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2 text-center">
                <div className="bg-gray-700/50 rounded-lg p-3">
                  <div className="text-lg font-bold text-purple-400">2,350</div>
                  <div className="text-xs text-gray-400">Users</div>
                </div>
                <div className="bg-gray-700/50 rounded-lg p-3">
                  <div className="text-lg font-bold text-green-400">573</div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="bg-gray-800/90 backdrop-blur-sm border-gray-700">
              <CardHeader>
                <CardTitle className="text-white text-lg sm:text-xl">Admin Statistics</CardTitle>
                <CardDescription className="text-gray-400 text-sm">Your administrative activity</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  <div className="text-center bg-gray-700/30 rounded-lg p-4">
                    <div className="text-xl sm:text-2xl font-bold text-blue-400">2,350</div>
                  ...
                  <div className="text-center bg-gray-700/30 rounded-lg p-4">
                    <div className="text-xl sm:text-2xl font-bold text-green-400">573</div>
                    <div className="text-xs sm:text-sm text-gray-400 flex items-center justify-center gap-1">
                  ...
                  <div className="text-center bg-gray-700/30 rounded-lg p-4">
                    <div className="text-xl sm:text-2xl font-bold text-red-400">17</div>
                    <div className="text-xs sm:text-sm text-gray-400 flex items-center justify-center gap-1">
              ...
              <CardContent className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-gray-400">Last changed 1 month ago</p>
                  </div>
                  <Button
                    variant="outline"
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-gray-400">Enhanced security for admin access</p>
                  </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div>
                    <p className="text-white font-medium text-sm sm:text-base">Admin Registration Key</p>
                    <p className="text-xs sm:text-sm text-gray-400">Manage admin registration access</p>
                  </div>
                  <Button
                    variant="outline"
                    className="border-gray-600 text-gray-300 hover:bg-gray-700 bg-transparent text-sm"
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div>
                    <p className="text-white font-medium text-sm sm:text-base">Session Management</p>
                    <p className="text-xs sm:text-sm text-gray-400">View and manage active sessions</p>
                  </div>
                  <Button
                    variant="outline"
                    className="border-gray-600 text-gray-300 hover:bg-gray-700 bg-transparent text-sm"
